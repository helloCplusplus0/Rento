...
- `phase11-deployment-cutover-and-cutline-closure` 已进入已批准 spec 的顺序实现：当前已落地 `deploy/caddy/Caddyfile` 与 `deploy/systemd/rento-minix.service`，并继续以 `docs/phase11_*` 作为部署切线真相源。
