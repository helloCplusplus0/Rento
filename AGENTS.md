...
- 当前阶段重点：
  ...
  - 冻结 `phase11` 当前轮仅文档变更时的最小验证要求，以及后续部署/回滚演练的最小记录字段、引用方式与审核用途
