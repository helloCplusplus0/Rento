...
function FunctionGridItem({ item }: { item: FunctionItem }) {
  return (
    <TouchCard onClick={item.onClick} className="aspect-square">
      <div
        className={cn(
    ...
    <div className={cn(`grid ${gridCols} gap-4 p-4`)}>
      {Array.from({ length: items }).map((_, i) => (
        <div key={i} className="aspect-square">
          <div className="flex h-full w-full animate-pulse flex-col items-center justify-center rounded-2xl bg-gray-200">
            <div className="mb-2 h-12 w-12 animate-pulse rounded-xl bg-gray-300" />
