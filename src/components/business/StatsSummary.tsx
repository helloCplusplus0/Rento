                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className={`text-sm font-medium ${
                      data.comparison.growthRate > 0 ? 'text-green-600' : 
                      data.comparison.growthRate < 0 ? 'text-red-600' : 'text-gray-400'
                    }`}>
                      {data.comparison.growthRate > 0 ? '+' : ''}{data.comparison.growthRate.toFixed(1)}%
                    </span>
                  </div>
                </div>
                <div className="text-xs text-gray-500">
                  上期: {formatCurrency(data.comparison.previousPeriod.totalAmount)}
                </div>
                <div className="text-xs text-gray-500">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
        {[1, 2, 3, 4].map((i) => (
          <Card key={i} className="overflow-hidden">
            <CardHeader className="pb-2 pt-3 px-4 bg-gray-50">
