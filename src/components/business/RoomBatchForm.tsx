...
export function RoomBatchForm({ building, onRoomsGenerate }: RoomBatchFormProps) {
  ...
  const totalRooms = (batchConfig.endFloor - batchConfig.startFloor + 1) * batchConfig.roomsPerFloor
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex flex-col">
                <button
                  type="button"
                  onClick={() => setBatchConfig(prev => ({ 
                    ...prev, 
                    startFloor: Math.min(50, prev.startFloor + 1)
                  }))}
                  className="px-2 py-1 text-xs bg-gray-100 hover:bg-gray-200 rounded-t border border-gray-300"
                >
                  ▲
                </button>
                <button
                  ...
                  className="px-2 py-1 text-xs bg-gray-100 hover:bg-gray-200 rounded-b border border-gray-300 border-t-0"
                >
                  ▼
                </button>
              </div>
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              <Input
                ...
                onChange={(e) => setBatchConfig(prev => ({ 
                  ...prev, 
                  endFloor: Math.max(prev.startFloor, parseInt(e.target.value) || 1)
                }))}
                className="flex-1"
              />
              <div className="flex flex-col">
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              <Input
                ...
                onChange={(e) => setBatchConfig(prev => ({ 
                  ...prev, 
                  defaultRent: Math.max(100, parseInt(e.target.value) || 1500)
                }))}
                className="flex-1"
              />
              <div className="flex flex-col">
