...
export interface MeterReadingHistoryPageClosureQuery {
  page?: unknown
  limit?: unknown
  meterId?: unknown
  contractId?: unknown
...
// keep history/status-repair semantics in one compat helper shared by Next and
// Hono so this task closes page routes without prematurely declaring API cutover.
export async function getMeterReadingsPageClosureData(
  query: MeterReadingHistoryPageClosureQuery
) {
...
export async function getMeterReadingStatusCheckPageClosureData() {
...
export async function repairMeterReadingStatusPageClosureData() {
