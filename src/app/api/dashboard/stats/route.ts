 ...
 */
async function handleDashboardStatsCompatProxy(request: NextRequest) {
  return proxyToFormalHost(request, {
    routeLabel: 'dashboard-stats-api',
    migrationHost: DASHBOARD_FORMAL_HOST,
    exitCondition: DASHBOARD_EXIT_CONDITION,
    compatMetadata: {
      closurePhase: 'phase14-06',
      compatReason: 'dashboard 统计主查询已切到统一 Hono 宿主，旧 Next 路由仅保留兼容代理。',
    },
  })
}

export const GET = handleDashboardStatsCompatProxy
