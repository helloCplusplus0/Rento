...
import { repairAllUtilityBillDetails, validateBillDetailsIntegrity, cleanupDuplicateDetails } from '@/lib/bill-detail-repair'
  ...
  try {
    ...
    return NextResponse.json({
      ...
      recommendations: {
        ...
        message: integrity.utilityBillsWithoutDetails > 0 
